...
cd ../twisp; RUSTFLAGS="-C target-feature=+crt-static" cargo +nightly b -r --target i686-unknown-linux-gnu --no-default-features -F rustls; cp target/i686-unknown-linux-gnu/release/twisp ../alpine/;
cd ../alpine;
