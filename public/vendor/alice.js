  ...
  function h2(type, props, ...children) {
    if (typeof type === "function") {
      ...
      for (const name in props) {
        ...
        if (isAJSReferences2(references) && name.startsWith("bind:")) {
          let reference = references[references.length - 1];
